        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorizedIps = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForClient = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtpConfirm = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Password = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NationalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmailConfirm = table.Column<bool>(type: "bit", nullable: true),
                    RegisterComplete = table.Column<bool>(type: "bit", nullable: false),
                    CustomerNumber = table.Column<long>(type: "bigint", nullable: true),
                    OtpCode = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true),
                    OtpCodeCreatedTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsOtpUsed = table.Column<bool>(type: "bit", nullable: true),
